...
ex_message1 = "第一个示例为: " + example1['instruction'] + ", output: " + json.dumps(example1['output'], ensure_ascii=False)
ex_message2 = "第二个示例为: " + example2['instruction'] + ", output: " + example2['output']
...
# 创建一个新的json文件
with open('./oneke_danci_其他8.json', 'w', encoding='utf-8') as new_file:
    # 遍历每一行
    for line in lines:
    # 解析JSON字符串
